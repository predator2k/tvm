...
if __name__ == "__main__":
    ...
    configs = [
        ...
        ("mblock",   make_mha_mblock_fused, 1024, 128, 32),
        ("mblock",   make_mha_mblock_fused, 1024, 128, 64),
        ("nonfused", make_mha_nonfused_one, 1024, 256, None),
        ("mblock",   make_mha_mblock_fused, 1024, 256, 32),
        ("mblock",   make_mha_mblock_fused, 1024, 256, 64),
        ("nonfused", make_mha_nonfused_one, 1024, 512, None),
        ("mblock",   make_mha_mblock_fused, 1024, 512, 32),
        ("nonfused", make_mha_nonfused_one, 2048, 128, None),
        ("mblock",   make_mha_mblock_fused, 2048, 128, 32),
        ("mblock",   make_mha_mblock_fused, 2048, 128, 64),
        ("nonfused", make_mha_nonfused_one, 2048, 256, None),
        ("mblock",   make_mha_mblock_fused, 2048, 256, 32),
    ]
